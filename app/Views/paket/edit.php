        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="card glass-panel border-0 p-4">
                <div class="card-header bg-transparent border-0 ps-0 pb-3 mb-3" style="border-bottom: 1px solid var(--glass-border) !important;">
                    <h4 class="fw-bold mb-1"><i class="fas fa-edit" style="color: var(--secondary-color); margin-right:.5rem;"></i>Edit Paket Layanan</h4>
                    <p class="text-muted mb-0 fs-7">Ubah detail informasi paket laundry Anda.</p>
                </div>

                <form action="/paket/edit/<?= $paket['id_paket'] ?>" method="post">
                    <!-- Nama Paket -->
                    <div class="mb-3">
                        <label class="form-label" for="nama_paket">Nama Paket</label>
                        <input type="text" id="nama_paket" name="nama_paket" class="form-control" value="<?= $paket['nama_paket'] ?>" required autocomplete="off">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="estimasi" name="estimasi" class="form-control" value="<?= $paket['estimasi'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="deskripsi" name="deskripsi" class="form-control" rows="4"><?= $paket['deskripsi'] ?></textarea>
                    </div>
