        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="card glass-panel border-0 p-4">
                <div class="card-header bg-transparent border-0 ps-0 pb-3 mb-3" style="border-bottom: 1px solid var(--glass-border) !important;">
                    <h4 class="fw-bold mb-1"><i class="fas fa-plus" style="color: var(--secondary-color); margin-right:.5rem;"></i>Tambah Order Laundry</h4>
                    <p class="text-muted mb-0 fs-7">Isi formulir di bawah ini untuk mencatat order baru dari pelanggan.</p>
                </div>
                ...
                <form action="/orders/create" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="nama_pelanggan" name="nama_pelanggan" class="form-control" placeholder="Nama lengkap pelanggan" required autocomplete="off">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" id="berat" name="berat" class="form-control" step="0.01" min="0.01" placeholder="0,00" required>
